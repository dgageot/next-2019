...
<div class="browser" id="browser">
    <div class="browser-navigation-bar">
        ...
        <span class="title">code ~ ${this.getAttribute('folder')}</span>
    </div>
...
.browser #refresh img:hover, .browser #chrome img:hover {
...
<div class="browser-navigation-bar">
    ...
    <span class="title">bash ~ ${path}</span>
    <a class="addtab" href="#">+</a>
</div>
